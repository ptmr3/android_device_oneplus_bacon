# Copyright (C) 2014 The Jedi Open Source Project
#
...
$(call inherit-product, vendor/jedi/config/gsm.mk)

# Enhanced NFC
$(call inherit-product, vendor/jedi/config/nfc_enhanced.mk)

# Inherit some common JEDI stuff.
$(call inherit-product, vendor/jedi/config/common_full_phone.mk)

PRODUCT_NAME := jedi_bacon
